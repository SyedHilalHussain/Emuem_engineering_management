    ...
    <div class="container">
        ...
        <div class="testimonial-slider owl-carousel owl-theme">
            ...
            <div class="testimonial-card">
                ...
                <p class="testimonial-text">The innovative programs and supportive faculty helped me the tech industry. The collaborative environment fostered innovation and critical thinking.</p>
                <div class="testimonial-bio">
                    <img src="./assets/img/all-img/user-1.png" alt="Sarah Johnson" class="bio-image">
                    <div class="bio-info">
                        <h4>Sarah Johnson</h4>
            ...
            <div class="testimonial-card">
                <div class="quote-icon">"</div>
                <p class="testimonial-text">The research opportunities and mentorship I received shaped my career in remarkable ways. The collaborative environment fostered innovation and critical thinking.</p>
                <div class="testimonial-bio">
                    <img src="./assets/img/all-img/user-1.png" alt="Michael Chen" class="bio-image">
                    <div class="bio-info">
                        <h4>Michael Chen</h4>
                        <span>Research Scientist, MIT</span>
                    </div>
                </div>
            </div>
            ...
            <div class="testimonial-card">
                <div class="quote-icon">"</div>
                <p class="testimonial-text">The entrepreneurship program provided me with the foundation and confidence to launch my own company. The network I built during my time here continues to be invaluable.</p>
                <div class="testimonial-bio">
                    <img src="./assets/img/all-img/user-1.png" alt="Emma Rodriguez" class="bio-image">
                    <div class="bio-info">
                        <h4>Emma Rodriguez</h4>
                        <span>Founder & CEO, EduTech Solutions</span>
                    </div>
                </div>
            </div>
            ...
            <div class="testimonial-card">
                <div class="quote-icon">"</div>
                <p class="testimonial-text">The global perspective and diverse community at the university prepared me perfectly for international business. The leadership opportunities shaped my management style.</p>
                <div class="testimonial-bio">
                    <img src="./assets/img/all-img/user-1.png" alt="David Wilson" class="bio-image">
                    <div class="bio-info">
                        <h4>David Wilson</h4>
                        <span>VP of Operations, Microsoft</span>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="events-area-2 pt-100">
        <div class="container">
            ...
            <div class="event lg" data-aos="fade-up" data-aos-delay="100">
                <div class="content">
                    <div class="image">
                        <img src="assets/img/all-img/events-image-1.png" alt="image">
                    </div>
                    <div class="text">
                ...
                <div class="col-lg-8">
                    <div class="recent-post">
                        ...
                        <div class="event" data-aos="fade-up" data-aos-delay="100">
                            <div class="content">
                                <div class="image">
                                    <img src="assets/img/all-img/events-image-2.png" alt="image">
                                </div>
                                <div class="text">
                                    ...
                                    <div class="link"><a href="v.html"><i class='bx bx-link-external'></i></a></div>
                                </div>
                            </div>
                        </div>
                        <div class="event" data-aos="fade-up" data-aos-delay="200">
                            <div class="content">
                                <div class="image">
                                    <img src="assets/img/all-img/events-image-3.png" alt="image">
                                </div>
                                <div class="text">
                                    <div class="tag">News</div>
